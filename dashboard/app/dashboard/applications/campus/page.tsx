...
export default function CampusTourPage() {
  ...
  const fetchData = useCallback(async () => {
    ...
    try {
      const reqRes = await bot1Api.listCampusTours();
  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-2xl font-bold">Campus Tour</h1>
          <p className="text-muted-foreground">Kampus sayohati so'rovlari</p>
        </div>
              ...
              <Table>
                <TableHeader>
                  <TableRow>
                    ...
                    <TableHead>Tashrif sanasi</TableHead>
                    ...
                    filteredReqs.map((req) => {
                      ...
                      return (
                        <TableRow key={req.id}>
                          ...
                          <TableCell>
                            <Link
                              href={`/dashboard/applications/campus/${req.id}`}
                            >
